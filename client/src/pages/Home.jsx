  ...
  return (
    <div className="min-h-screen h-auto w-full bg-[#343F4F]">
      <div className="flex flex-col md:flex-row pl-5 md:pl-20 pt-10 md:pt-20 pb-10">
        <div className="text-white text-[25px] md:text-[55px] font-[400]">
          Hello
        </div>
      ...
      <div className="w-[90vw] md:w-[50vw] pl-5 md:pl-20 text-white text-[15px] md:text-[25px] font-[400]">
        <p>
          ...
          web development playground, and AI chat assistant provide all the
          tools you need. Start your dream project today and bring your
          imagination to life with CodeWorks!
        </p>
